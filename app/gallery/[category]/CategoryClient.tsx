...
const categoryMeta: Record<string, { label: string; labelEn: string; icon: string; accent: string; bg: string }> = {
  ...
  "shepherd-tv":               { label: "شيبرد TV",             labelEn: "Shepherd-TV",              icon: "📺", accent: "#A87EC9", bg: "linear-gradient(135deg, #090610 0%, #100c1a 40%, #15102a 100%)" },
  "wood-plastic-composite":    { label: "الخشب البلاستيكي المركّب", labelEn: "Wood Plastic Composite", icon: "🌿", accent: "#7EC987", bg: "linear-gradient(135deg, #060a06 0%, #0a100a 40%, #0d160d 100%)" },
};
